...
(function(c, b, a, d) {
  c.fn.kkstarratings = function(e) {
    c.fn.kkstarratings.options = c.extend({
      ajaxurl: null,
      nonce: null,
      func: null,
      grs: false,
    ...
    }, c.fn.kkstarratings.options, e ? e : {});
    var f = [];
    this.each(function() {
      f.push(c(this))
    });
  ...
  c.fn.kkstarratings.animate = function(g) {
    if (!g.hasClass("disabled")) {
      var f = c(".kksr-legend", g).html(),
        e = c(".kksr-fuel", g).css("width");
      c(".kksr-stars a", g).hover(function() {
        ...
        c(".kksr-fuel", g).stop(true, true).animate({
          width: e
        }, c.fn.kkstarratings.options.fuelspeed)
  ...
  c.fn.kkstarratings.update = function(h, e, g, f, i) {
    ...
    c(".kksr-fuel", h).stop(true, true).animate({
      width: e
    }, c.fn.kkstarratings.options.fuelspeed, "linear", function() {
      if (f == "true") {
        h.addClass("disabled");
  ...
  c.fn.kkstarratings.click = function(h, e) {
    ...
    var g = c(".kksr-legend", h).html(),
      f = c(".kksr-fuel", h).css("width");
  ...
  c.fn.kkstarratings.fetch = function(g, e, i, h, j) {
    ...
    c.ajax({
      url: c.fn.kkstarratings.options.ajaxurl,
      data: "action=" + c.fn.kkstarratings.options.func + "&id=" + f + "&stars=" + e + "&_wpnonce=" + c.fn.kkstarratings.options.nonce,
      type: "post",
      dataType: "json",
      beforeSend: function() {
        c(".kksr-fuel", g).animate({
          width: "0%"
        }, c.fn.kkstarratings.options.fuelspeed);
        if (e) {
